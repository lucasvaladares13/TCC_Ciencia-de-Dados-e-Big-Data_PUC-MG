...
with open(path_results + "08_Resultados.txt", "a") as stream:
...
fig = plt.figure()
fig.suptitle("Comparação dos Modelos Hiperparametros")
ax = fig.add_subplot(111)
plt.boxplot(results)
ax.set_xticklabels(names)
plt.savefig(path_images + "08_" + "BoxPlot_Models" + '.png', dpi=300)
# plt.show()
plt.close()
